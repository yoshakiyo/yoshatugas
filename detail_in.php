    ...
    <div class="grid fluid">		
		<div class="row">
			<div class="span11 offset0.5 " style="margin-top:100px;">
				...
				?>
				<tr><th>No</th><th>Nama Nelayan</th><th>No KTP</th><th>No Kartu Nelayan</th><th>Tanggal Lahir</th><th>Jenis Kelamin</th><th>Alamat</th><th>Kota</th><th>No Telpon</th><th>Jabatan</th></tr>
				  <?php		   
						include 'koneksi.php';
						...
						echo "<tr><td>$no</td><td>$a</td><td>$b</td><td>$c</td><td>$d</td><td>$e</td><td>$f</td><td>$g</td><td>$h</td><td>$i</td></tr>";
						$no++;
						}				   
					?>
			  </table>  
